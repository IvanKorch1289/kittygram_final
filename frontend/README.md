![](https://github.com/IvanKorch1289/kittygram_final/actions/workflows/main.yml/badge.svg?event=push&branch=main)
...
1. Склонируйте репозиторий на свой компьютер:
    ```
    git clone https://github.com/IvanKorch1289/kittygram_final.git
    ```
